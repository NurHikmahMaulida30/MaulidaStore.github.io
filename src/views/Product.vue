        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-6">
                            <!--Mengatur Tampilan gambar utama pada product-->
                            <div class="product-pic-zoom">
                                <img class="product-big-img" :src="gambar_default" alt="" />
                            </div>
                            <!--Mengatur Gambar product option-->
                            <div class="product-thumbs">
                                <carousel  :dot="false" :nav="false" class="product-thumbs-track ps-slider ">
                                    <!--Mengatur gambar jika ditekan akan muncul ke tampilan gabar utama-->
...
import HeaderMaulida from '@/components/HeaderMaulida.vue'
import FooterSelection from '@/components/FooterSelection.vue'
